            ...
            <form className="mt-8 space-y-6" onSubmit={ Register }>
                {
                    msg && (
                        <div className='text-center rounded-lg border-4 border-sky-100 border-l-sky-300'>
                            ...
                            <p className='m-3 text-slate-500'>{msg} <br/><a href='/'>Login here...</a></p>
                        </div>
                    )
                }
                {
                ...
                <div className="rounded-md shadow-sm -space-y-px">
                    ...
                    <div>
                        ...
                        value={jobdesk} onChange={(e) => setJobdesk(e.target.value)} required
                        >
                            <option value=''>Job Desk</option>
                            <option value="NOC">NOC</option>
                            <option value="Network Enginer">Network Enginer</option>
                            <option value="Lead Network Enginer">Lead Network Enginer</option>
                        </select>
                    </div>
                    <div>
                        <label className="sr-only">
                    ...
                    <div>
                        ...
                        value={telp} onChange={(e) => setTelp(e.target.value)} required
                        />
                    </div>
                    <div>
